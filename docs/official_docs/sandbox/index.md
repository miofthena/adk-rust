...
adk-sandbox = { version = "1.1.0", features = ["process", "sandbox-native"] }

# Or pick a specific platform
adk-sandbox = { version = "1.1.0", features = ["process", "sandbox-macos"] }
adk-sandbox = { version = "1.1.0", features = ["process", "sandbox-linux"] }
```
